...
resource "databricks_group_member" "admins_2774833133357283_ajay_singh" {
  member_id = databricks_user.ajay_singh.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_asher_bartch" {
  member_id = databricks_user.asher_bartch.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_ganeshrj_hdpmi_adf_user_assigned_mi" {
  member_id = databricks_service_principal.ganeshrj_hdpmi_adf_user_assigned_mi_8442090486855365.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_ganeshrj_mi_adf_appl_id" {
...
resource "databricks_group_member" "admins_2774833133357283_ganeshrj_sqldb_readonly" {
  member_id = databricks_group.ganeshrj_sqldb_readonly_3427963871004739.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_ganeshrj_sqldbadmin" {
  member_id = databricks_group.ganeshrj_sqldbadmin_3239514562238688.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_guido_oswald" {
  member_id = databricks_user.guido_oswald.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_kayla_grieme" {
  member_id = databricks_user.kayla_grieme.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_kevin_barlow" {
  member_id = databricks_user.kevin_barlow.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_luis_moros" {
  member_id = databricks_user.luis_moros.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_mangedidentities" {
  member_id = databricks_group.mangedidentities_790905299331875.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_metastore_admin_users" {
  member_id = databricks_group.metastore_admin_users_851247659650529.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_nathan_anthony" {
  member_id = databricks_user.nathan_anthony.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_odl_user_231560" {
  member_id = databricks_user.odl_user_231560.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_parth_vakil" {
  member_id = databricks_user.parth_vakil.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_patrick_bayne" {
  member_id = databricks_user.patrick_bayne.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_prithish_mathews" {
  member_id = databricks_user.prithish_mathews.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_rafi_kurlansik" {
  member_id = databricks_user.rafi_kurlansik.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_ricardo_sugawara" {
  member_id = databricks_user.ricardo_sugawara.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_roger_ding" {
  member_id = databricks_user.roger_ding.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_scott_stafford" {
  member_id = databricks_user.scott_stafford.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_spentitlements" {
  member_id = databricks_group.spentitlements_459335653644651.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
...
resource "databricks_group_member" "admins_2774833133357283_todd_cowles" {
  member_id = databricks_user.todd_cowles.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
resource "databricks_group_member" "admins_2774833133357283_unity_west" {
...
resource "databricks_group_member" "admins_2774833133357283_vivek_singh" {
  member_id = databricks_user.vivek_singh.id
  group_id  = data.databricks_group.admins_2774833133357283.id
}
