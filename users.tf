...
resource "databricks_user" "ajay_singh" {
  workspace_access           = true
  user_name                  = "ajay.singh@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
...
resource "databricks_user" "asher_bartch" {
  workspace_access           = true
  user_name                  = "asher.bartch@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
...
resource "databricks_user" "guido_oswald" {
  workspace_access           = true
  user_name                  = "guido.oswald@databricks.com"
  force                      = true
  databricks_sql_access      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
...
resource "databricks_user" "kayla_grieme" {
  workspace_access           = true
  user_name                  = "kayla.grieme@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "kevin_barlow" {
  user_name                  = "kevin.barlow@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
...
resource "databricks_user" "luis_moros" {
  user_name                  = "luis.moros@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "nathan_anthony" {
  user_name                  = "nathan.anthony@databricks.com"
  force                      = true
  databricks_sql_access      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
...
resource "databricks_user" "odl_user_231560" {
  user_name                  = "odl_user_231560@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "parth_vakil" {
  user_name                  = "parth.vakil@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "patrick_bayne" {
  workspace_access           = true
  user_name                  = "patrick.bayne@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "prithish_mathews" {
  workspace_access           = true
  user_name                  = "prithish.mathews@databricks.com"
  force                      = true
  databricks_sql_access      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
...
resource "databricks_user" "rafi_kurlansik" {
  workspace_access           = true
  user_name                  = "rafi.kurlansik@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
...
resource "databricks_user" "ricardo_sugawara" {
  workspace_access           = true
  user_name                  = "ricardo.sugawara@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
resource "databricks_user" "roger_ding" {
  workspace_access           = true
  user_name                  = "roger.ding@databricks.com"
  force                      = true
  databricks_sql_access      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
...
resource "databricks_user" "scott_stafford" {
  user_name                  = "scott.stafford@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
...
resource "databricks_user" "todd_cowles" {
  user_name                  = "todd.cowles@databricks.com"
  force                      = true
  databricks_sql_access      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
...
resource "databricks_user" "vivek_singh" {
  user_name                  = "vivek.singh@databricks.com"
  force                      = true
  allow_instance_pool_create = true
  allow_cluster_create       = true
}
